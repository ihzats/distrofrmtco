...
class Payment extends CI_Controller
{
	...
	public function finish()
	{
		$this->session->unset_userdata([
			'id_orders', 'kurir', 'service', 'estimasi', 'alamat_pengiriman',
	...
	public function unfinish()
	{
		...
		$this->cart->destroy();
		$this->freeM->getSweetAlert('infoPayment', 'Payment Unfinish!', 'Pemesanan gagal di lakukan!', 'info');
		redirect('home');
	}
	...
	public function error()
	{
		...
		$this->cart->destroy();
		$this->freeM->getSweetAlert('infoPayment', 'Payment Error!', 'Pemesanan gagal di lakukan!', 'error');
		redirect('home');
	}
