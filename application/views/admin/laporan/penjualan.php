              ...
              <div class="x_content">
                ...
                <div class="bs-example" data-example-id="simple-jumbotron">
                  <div class="jumbotron text-center">
                    <!-- <h1>Hello, world!</h1> -->
                    <p class="text-center">Pemilik dapat mencetak laporan penjualan yang terjadi pada toko.</p>
                    ...
                    <h6 class="text-center" id="ketDateRange">Menampilkan semua data penjualan.</h6>
                  </div>
                </div>
