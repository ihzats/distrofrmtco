											...
											<?php foreach ($settlement as $item) : ?>
												<tr>
													...
													<td class="text-center">
														<a href="" class="text-info sett_detail" data-toggle="modal" data-target=".modal-detail" data-id_target="<?= $item['id_orders'] ?>" data-status_order="<?= $item['status_order'] ?>" data-kurir="<?= $item['kurir'] ?>" data-service="<?= $item['service'] ?>" data-estimasi="<?= $item['estimasi'] ?>" data-nama_penerima="<?= $item['nama_penerima'] ?>" data-alamat="<?= $item['alamat_pengiriman'] ?>" data-kode_pos="<?= $item['kode_pos'] ?>" data-telefon="<?= $item['no_penerima'] ?>" data-berat="<?= $item['berat'] ?>" data-tot_ongkir="<?= $item['total_ongkir'] ?>" data-tot_barang="<?= $item['total_harga_barang'] ?>" data-tot_all="<?= $item['gross_amount'] ?>" data-dibayar_pada="<?= $item['settlement_time'] ?>">
															Detail Pesanan
														</a> |
														<a href="" class="text-info btn-input-resi" data-toggle="modal" data-target="#input-resi" data-id_orders="<?= $item['id_orders'] ?>">
															Input Resi
														</a>
													</td>
												</tr>
							...
							<div class="row">
								...
								<div class="col text-center">
									...
									<a href="#" id="batalkan-order" style="display: none;">
										<button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Hati-hati, ini tidak dapat di ulangi!" class="btn btn-danger source">Batalkan Pesanan
										</button>
									</a>
								</div>
							</div>
