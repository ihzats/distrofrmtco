			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="<?= base_url('home') ?>" class="site_title"><i class="fa fa-shopping-basket"></i> <span> FRMT.CO</span></a>
					</div>
											...
											<?php foreach ($orders as $item) : ?>
												<tr>
													...
													<td class="text-center">
														<a href="" class="text-info sett_detail" data-toggle="modal" data-target=".modal-detail" data-id_target="<?= $item['id_orders'] ?>" data-id_orders_enc="<?= encrypt_url($item['id_orders']) ?>" data-kurir="<?= $item['kurir'] ?>" data-service="<?= $item['service'] ?>" data-estimasi="<?= $item['estimasi'] ?>" data-nama_penerima="<?= $item['nama_penerima'] ?>" data-alamat="<?= $item['alamat_pengiriman'] ?>" data-kode_pos="<?= $item['kode_pos'] ?>" data-telefon="<?= $item['no_penerima'] ?>" data-berat="<?= $item['berat'] ?>" data-tot_ongkir="<?= $item['total_ongkir'] ?>" data-tot_barang="<?= $item['total_harga_barang'] ?>" data-tot_all="<?= $item['gross_amount'] ?>" data-dibayar_pada="<?= $item['settlement_time'] ?>" data-notif="<?= $item['notifikasi_email'] ?>">
															Detail Pesanan
														</a> |
														<a href="" class="text-info btn-update-resi" data-toggle="modal" data-target="#input-resi" data-id_orders="<?= $item['id_orders'] ?>" data-resi="<?= $item['nomer_resi'] ?>">
															Update Resi
														</a>
													</td>
												</tr>
							...
							<div class="row">
								...
								<div class="col text-center">
									...
									<a href="#" id="send-notif">
										<button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Mengirim notifikasi ke Pelanggan untuk mengkonfirmasi barang sudah sampai. Ini hanya dapat dilakukan satu kali!" class="btn btn-primary source">Kirim Notifikasi Konfirmasi
										</button>
									</a>
								</div>
							</div>
