							...
							<div class="x_panel">
								...
								<div class="x_content">
									<p class="text-muted font-13 m-b-30">
										Menampilkan seluruh data admin pada Distro FRMT.CO.
									</p>
												...
												<tr>
													...
													<td class="text-center">
														<?php if ($key['is_active'] == 1) { ?>
															<a tabindex="-1" href="#" onclick="set_url1('<?= site_url('dashboard/admin/nonaktif_admin/' . encrypt_url($key['id_user']))  ?>')" id="btnHapus" data-toggle="modal" data-target="#m_nonaktif">Nonaktifkan</a>
														<?php } else { ?>
															<a tabindex="-1" href="#" onclick="set_url2('<?= site_url('dashboard/admin/aktif_admin/' . encrypt_url($key['id_user']))  ?>')" id="btnHapus" data-toggle="modal" data-target="#m_aktif">Aktifkan</a>
														<?php } ?>
														|
														<a tabindex="-1" href="#" onclick="set_url('<?= site_url('dashboard/admin/delete_admin/' . encrypt_url($key['id_user']))  ?>')" id="btnHapus" data-toggle="modal" data-target="#kt_modal_1">Hapus Admin</a>
			...
			<div class="modal fade" id="m_nonaktif" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Anda yakin ingin Mengnonaktifkan Admin ini?</p>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
