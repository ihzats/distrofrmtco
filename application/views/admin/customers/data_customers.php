							...
							<div class="x_panel">
								...
								<div class="x_content">
									<p class="text-muted font-13 m-b-30">
										Menampilkan seluruh data pelanggan pada Distro FRMT.CO.
									</p>
											...
											foreach ($customers as $key) :  ?>
												<tr>
													...
													<td class="text-center">
														<a role="menuitem" tabindex="-1" href="#" onclick="set_url('<?= site_url('dashboard/admin/delete_customers/' . encrypt_url($key['id_user']))  ?>')" id="btnHapus" data-toggle="modal" data-target="#kt_modal_1">Hapus Pelanggan</a>

														<?php if ($key['is_active'] == 1) : ?>
															|
															<a role="menuitem" tabindex="-1" href="#" onclick="set_url1('<?= site_url('dashboard/admin/nonaktif_customers/' . encrypt_url($key['id_user']))  ?>')" id="btnNonaktif" data-toggle="modal" data-target="#kt_modal_2">Nonaktifkan Pelanggan</a>
														<?php else : ?>
															|
															<a role="menuitem" tabindex="-1" href="#" onclick="set_url2('<?= site_url('dashboard/admin/aktifkan_customers/' . encrypt_url($key['id_user']))  ?>')" id="btnAktif" data-toggle="modal" data-target="#kt_modal_3">Kirim Email Pengaktifan</a>
														<?php endif; ?>
													</td>
												</tr>
											<?php endforeach; ?>
