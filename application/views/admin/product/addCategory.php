                                  ...
                                  <td class="text-center">
                                    <li role="presentation" class="dropdown" style="list-style: none;">
                                      ...
                                      <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnEditParent" data-target=".modal-parente" data-toggle="modal" data-id="<?= $key['parent_kategori_id'] ?>" data-nama-parent="<?= $key['parent_kategori_nama'] ?>">
                                ...
                                <td class="text-center">
                                  <li role="presentation" class="dropdown" style="list-style: none;">
                                    ...
                                    <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                      ...
                                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnEdit" data-toggle="modal" data-target=".bs-example-modal-lg" data-toggle="modal" data-id="<?= $key['id_cat'] ?>" data-namaold="<?= $key['nama_cat'] ?>" data-ketold="<?= $key['ket_cat'] ?>">
                                          Edit Cat</a>
                                      </li>
                                    </ul>
                                  </li>
                                ...
                                <td class="text-center">
                                  <li role="presentation" class="dropdown" style="list-style: none;">
                                    ...
                                    <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                      ...
                                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnEdit1" data-toggle="modal" data-target=".bs-example-modal-lg" data-toggle="modal" data-id="<?= $key['id_cat'] ?>" data-namaold="<?= $key['nama_cat'] ?>" data-ketold="<?= $key['ket_cat'] ?>">
                                          Edit Cat</a>
                                      </li>
                                    </ul>
                                  </li>
