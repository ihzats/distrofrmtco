                                  ...
                                  <td class="text-center">
                                    <li role="presentation" class="dropdown" style="list-style: none;">
                                      ...
                                      <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnEdit" data-toggle="modal" data-target=".bs-example-modal-lg" data-toggle="modal" data-id="<?= $key['id_tags'] ?>" data-namaold="<?= $key['nama_tag'] ?>" data-ketold="<?= $key['ket_tag'] ?>">
                                            Edit Tag</a>
                                        </li>
                                      </ul>
                                    </li>
                                  ...
                                  <td class="text-center">
                                    <li role="presentation" class="dropdown" style="list-style: none;">
                                      ...
                                      <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnEdit1" data-toggle="modal" data-target=".bs-example-modal-lg" data-toggle="modal" data-id="<?= $key['id_tags'] ?>" data-namaold="<?= $key['nama_tag'] ?>" data-ketold="<?= $key['ket_tag'] ?>">
                                            Edit Tag</a>
                                        </li>
                                      </ul>
                                    </li>
