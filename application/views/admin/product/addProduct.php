												...
												<div class="form-group">
													<div class='input-group'>
														<select required multiple="multiple" name="ukuran[]" class="form-control ukuran">
															...
															<option value="Uk-29" <?= set_select('ukuran[]', '29'); ?>>29</option>
															<option value="Uk-30" <?= set_select('ukuran[]', '30'); ?>>30</option>
															<option value="Uk-31" <?= set_select('ukuran[]', '31'); ?>>31</option>
															<option value="Uk-31" <?= set_select('ukuran[]', '32'); ?>>32</option>
														</select>
														<span class="input-group-addon">
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="row">
										<div class="x_panel">
											...
											<div class="x_content">
												<textarea id="message" required="required" class="form-control" name="ket_produk" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Deskripsi kan sejelas mungkin.." data-parsley-validation-threshold="10"><?= set_value('ket_produk') ?></textarea>
											</div>
