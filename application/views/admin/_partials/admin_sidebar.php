	...
	<ul class="nav side-menu">
		...
		<li><a><i class="fa fa-edit"></i> Laporan <span class="fa fa-chevron-down"></span></a>
			<ul class="nav child_menu">
				...
				<li><a href="<?= base_url('dashboard/admin/laporan_barang') ?>">Barang</a></li>
				<li><a href="<?= base_url('dashboard/admin/laporan_pelanggan') ?>">Pelanggan</a></li>
			</ul>
		</li>

		<li><a href="<?= base_url('dashboard/admin/contact_us') ?>"><i class="fa fa-edit"></i> Data Contact Us</a>
