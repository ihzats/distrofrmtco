      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card text-center">
            <div class="card-header"> Konfirmasi Penerimaan Barang</div>
            <div class="card-body">
              <h5 class="card-title">Anda akan mengkonfirmasi penerimaan barang yang telah anda pesan <br>
            ...
            <div class="card-footer text-muted">FRMT.CO</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p contenteditable="true">Tindakan ini tidak dapat di ulangi.</p>
        </div>
        <div class="modal-footer"> <button type="button" class="btn btn-primary" data-dismiss="modal">Batal</button>
          <a href="<?= base_url('pesanan/prosses_konfirmasi/' . $trx_id . '/' . $email) ?>"><button type="button" class="btn btn-secondary">Setuju</button></a>
        </div>
      </div>
    </div>
  </div>
