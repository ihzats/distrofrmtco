...
<head>
  ...
  <script type="text/javascript">
    window.$crisp = [];
    window.CRISP_WEBSITE_ID = "5b93cfb8-84a6-4104-a94c-3410322d16d4";
    (function() {
      d = document;
...
<body>
  ...
  <div id="carousel-example-1z" class="carousel slide carousel-fade pt-4" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active">
        <div class="view" style="background-image: url('<?= base_url() ?>/assets/images/banner1.png'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn ">
              <h1 class="mb-4">
                <img src="<?= base_url() ?>/assets/images/logo.png" alt="images/logo">
              </h1>
      ...
      <div class="carousel-item">
        <div class="view" style="background-image: url('<?= base_url() ?>/assets/images/banner2.jpg'); background-repeat: no-repeat; background-size: cover;">
      ...
      <!--Third slide-->
      <div class="carousel-item">
        <div class="view" style="background-image: url('<?= base_url() ?>/assets/images/banner3.png'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              ...
              <p class="mb-4 d-none d-md-block">
                <strong>Toko FRMT.CO hadir dengan berbagai kemudahan untuk anda dalam yang berkeinginan tampil
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card" style="height: 400px">
                ...
                <div class="view overlay">
                  <img src="<?= base_url('assets/images/produk/' . $item['gambar_produk']) ?>" style="padding: 5px;" width="372" height="431" class="card-img-top img-fluid" alt="">
  ...
  <!--      © --><? //= date('Y') 
                  ?>
  <!-- Copyright:-->
  <!--      <a href="https://www.instagram.com/r.ihzaaa/"> r.ihzaaa </a>-->
  <!--    </div>-->
  <!---->
  <!---->
  <!--  </footer>-->
