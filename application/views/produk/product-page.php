...
<body>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="<?= base_url('assets/images/produk/' . $produk['gambar_produk']) ?>" style="max-width: 420px; max-height: 480px;" height="420" width="420" id="bigPicture" class="img-fluid zoom mb-4" alt="">
          <hr>
          <a href="#">
            <img src="<?= base_url('assets/images/produk/' . $produk['gambar_produk']) ?>" id="mainPicture" data-src="<?= base_url('assets/images/produk/' . $produk['gambar_produk']) ?>" style="border-style: solid; border-color: #2a6496; width: 120px; height: 120px;" height="120" width="120" class="img-fluid" alt="">
          </a>
          <a href="#">
            <?php if ($produk['gambar_tambahan'] != NULL) : ?>
              <img src="<?= base_url('assets/images/produk/' . $produk['gambar_tambahan']) ?>" id="addonPicture" data-src="<?= base_url('assets/images/produk/' . $produk['gambar_tambahan']) ?>" style="border-style: solid; border-color: #2a6496; width: 120px; height: 120px;" height="120" width="120" class="img-fluid" alt="">
            <?php endif; ?>
          </a>
          <!--  -->
        </div>
      ...
      <div class="row wow fadeIn">
        ...
        <?php foreach ($produkLain as $items) : ?>
          <div class="col-md-6">
            <div class="card m-3 blogBox moreBox" style="max-width: 520em;height:200px;display: none;">
              <a href="<?= base_url('produk/detail/' . encrypt_url($items['unik_produk'])) ?>">
                <div class="row no-gutters">
                  <div class="col-md-4">
                    <img src="<?= base_url('assets/images/produk/' . $items['gambar_produk']) ?>" style="max-height: 190px; margin-left: 10px; margin-top: 5px;" class="card-img" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="text-muted font-weight-bold blue-text">
                          <h4>Rp
                            <?= number_format($items['harga_produk'] - $items['harga_produk'] * $items['diskon'] / 100, 0, ',', '.') ?></h4>
                        </small></p>
                    </div>
                  </div>
                </div>
  ...
  <!--      © 2019 Copyright:-->
  <!--      <a href="https://www.instagram.com/rahmaap__/"> rahmaap__ </a>-->
  <!--    </div>-->
  <!---->
  <!---->
  <!--  </footer>-->
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#addonPicture').click(function() {
        $('#bigPicture').attr('src', $(this).data('src'))
      })
