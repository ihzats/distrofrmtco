      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          ...
          <form action="<?= base_url('payment/checkout') ?>" id="payment-form" method="post" class="p-2">
            ...
            <div class="d-flex justify-content-center" data-toggle="infoBtnBayar" title="Silahkan isi data pengiriman dahulu, lalu klik button Cek untuk melanjutkan pembayaran">
              <button class="btn btn-secondary btn-md waves-effect m-0" id="btnBayar" disabled style="width:100%" name="submit" type="submit">Lanjutkan Pembayaran</button>
            </div>
          </form>
          <!-- Promo code -->
